...
ON t.id=c.tour_id LEFT JOIN ' . $GOGIES['dbprf'] . 'cities city ON city.lang_id=t.start_city WHERE  c.lang=\'' . $GOGIES['lang'] . '\' AND  t.status=\'1\' AND city.lang=\'' . $GOGIES['lang'] . '\' AND t.start_country=\'113\' ORDER BY rand() DESC  LIMIT ' . $GOGIES['tours_settings']['latest_tours_number']);
