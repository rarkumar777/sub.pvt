...
(function ($, window, document) {
    ...
    var pluginName = "wickedpicker",
        defaults = {
            ...
            twentyFour: false,
            upArrow: 'fa-chevron-up block',
            downArrow: 'fa-chevron-down block',
    ...
    $.extend(Wickedpicker.prototype, {
        ...
        showPicker: function (element) {
            ...
            if (this.getText(element) !== this.getTime()) {
                ...
                // Check meridiem 
                if (this.getText(element) === '') {
                    var text = this.formatTime(this.selectedHour, this.selectedMin, this.selectedMeridiem, this.selectedSec);
                }
                else {
        ...
        makePickerInputClearable: function (input) {
            $(input).wrap('<div class="clearable-picker relative"></div>').after('<span class="btn absolute h-pad top right" style="margin-top:5px; margin-right:3px;" data-clear-picker><i class="fa-trash-o"></i></span>');
