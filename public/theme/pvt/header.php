...
<!DOCTYPE html>
<html dir="<?=$GOGIES['lang_dir']?>" lang="<?=strtolower($GOGIES['lang'])?>">
  <head>
 <meta charset="utf-8">
...
<meta name="keywords" content="<?=$GOGIES['key_words']?>">
<meta name="description" content="<?=$GOGIES['meta_desc']?>">
<?=$GOGIES['head_tags']?>


</head>

<body lang="<?=strtolower($GOGIES['lang'])?>">
