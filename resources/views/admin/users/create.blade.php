...
<div class="tw-flex tw-justify-between tw-items-center tw-mb-10">
    <div>
        ...
        <p class="subtitle">Fill in the details below to create a new administrative or client account.</p>
    </div>
    ...
    <div class="box !tw-p-10">
        ...
        <div class="form-section">
            ...
            <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-3 tw-gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="last_name" value="{{ old('last_name') }}" placeholder="e.g. Doe">
                </div>
                <div>
                    <label>Company Name</label>
                    <input type="text" name="company" value="{{ old('company') }}" placeholder="Organization or Company">
                </div>
                <div class="md:tw-col-span-3">
                    <label>Profile Avatar</label>
                    <input type="file" name="avatar" class="!tw-py-8 !tw-h-auto !tw-border-dashed tw-bg-slate-50/50">
                </div>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-3 tw-gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="mobile" value="{{ old('mobile') }}" placeholder="+1 (555) 000-0000">
                </div>
                ...
                <div>
                    ...
                    <select name="country" id="country" onchange="do_ajax('#city','{{ url('/') }}/ajax/cities.php?input=city&c='+document.getElementById('country').value,'');">
                        ...
                        <option value="{{ $cid }}" {{ old('country') == $cid ? 'selected' : '' }}>{{ $cname }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="birth_day" value="{{ old('birth_day') }}" placeholder="YYYY-MM-DD" class="datepicker" data-disable-dates="future" data-view-mode="years">
                </div>
            </div>
        </div>
            ...
            <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-3 tw-gap-6">
                <div>
                    ...
                    <select name="user_group">
                        ...
                        <option value="{{ $ug }}" {{ old('user_group', 'clients') == $ug ? 'selected' : '' }}>{{ $ug }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
        ...
        <div class="tw-mt-12 tw-pt-8 tw-border-t tw-border-slate-100 tw-flex tw-justify-end">
            <button type="submit" class="btn orange !tw-px-10 !tw-h-14 tw-text-base">
                <i class="fa fa-check-circle"></i> Create User Account
            </button>
        </div>
